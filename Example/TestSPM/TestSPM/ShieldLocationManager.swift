...
class ShieldLocationManager: NSObject, CLLocationManagerDelegate {

    static let shared = ShieldLocationManager()
    ...
    public func requestLocationAuthorization() {
        ...
        debugPrint("asking location")
        // Only ask authorization if it was never asked before
        guard currentStatus == .notDetermined else { return }
        debugPrint("location not determined")
